...
@Component({
    selector: 'notif-transfer-approved',
    ...
    template: `
        <div class="flex flex-auto flex-col gap-1">
            <div class="flex items-center gap-1">
                <mat-icon
                    class="text-green-500 icon-size-6"
                    [svgIcon]="'heroicons_solid:check-circle'"
                />
                <p class="line-clamp-1 font-bold">Virement approuvé</p>
            </div>
...
export class TransferApprovedComponent {
